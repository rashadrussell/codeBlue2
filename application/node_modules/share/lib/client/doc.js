  ...
  Doc.prototype._onMessage = function(msg) {
    ...
    switch (false) {
      ...
      case !msg.op:
        ...
        for (cid in _ref6) {
          cursor = _ref6[cid];
          this.cursors[cid] = this.type.transformCursor(cursor, docOp, cid === msg.meta.source.toString());
        }
        if (this.cursor) {
          this.cursor = this.type.transformCursor(this.cursor, docOp, false);
        }
        this.version++;
