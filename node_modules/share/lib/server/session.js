...
exports.handler = function(session, createAgent) {
  var agent, buffer, bufferMsg, close, data, docState, failAuthentication, handleClose, handleMessage, handleOp, handleOpenCreateSnapshot, lastReceivedDoc, lastSentDoc, open, send, timeout;
  data = {
